...
plotter(linear_trajectory.t, linear_trajectory.y[0].T, "t - time (s)", "$\overline{x}_1$ - position (m)", "Linear System at Equilibrium", '.\\Figures\\linear_system_equil.svg')
plotter(non_linear_trajectory.t, non_linear_trajectory.y[0].T, "t - time (s)", "$x_1$ - position (m)", "Non-Linear System at Equilibrium", '.\\Figures\\nonlinear_system_equil.svg')
...
plotter(linear_trajectory.t, linear_trajectory.y[0].T, "t - time (s)", "$\overline{x}_1$ - position (m)", "Linear System starting 3.5cm from Equilibrium", '.\\Figures\\linear_system_3_5_cm.svg')
plotter(non_linear_trajectory.t, non_linear_trajectory.y[0].T, "t - time (s)", "$x_1$ - position (m)", "Non-Linear System starting 3.5cm from Equilibrium", '.\\Figures\\nonlinear_system_3_5_cm.svg')
